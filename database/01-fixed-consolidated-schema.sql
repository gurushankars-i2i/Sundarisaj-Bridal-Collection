-- =====================================================
-- SUNDARISAJ BRIDAL COLLECTION - FIXED CONSOLIDATED SCHEMA
...
-- Users policies - FIXED: No circular references
...
-- FIXED: Use user metadata instead of querying users table
...
BEGIN
    RAISE NOTICE '=====================================================';
    RAISE NOTICE 'SUNDARISAJ BRIDAL COLLECTION - FIXED SCHEMA SETUP COMPLETE';
    RAISE NOTICE '=====================================================';
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🔧 FIXED: RLS policies now use JWT metadata instead of';
    RAISE NOTICE '   querying the users table (prevents infinite recursion)';
    RAISE NOTICE '';
